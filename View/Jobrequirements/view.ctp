<div class="jobrequirements view">
<h2><?php echo __('Jobrequirement'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($jobrequirement['Jobrequirement']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($jobrequirement['Jobrequirement']['name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Jobrequirement'), array('action' => 'edit', $jobrequirement['Jobrequirement']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Jobrequirement'), array('action' => 'delete', $jobrequirement['Jobrequirement']['id']), array(), __('Are you sure you want to delete # %s?', $jobrequirement['Jobrequirement']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($jobrequirement['Job'])): ?>
	...
	<?php foreach ($jobrequirement['Job'] as $job): ?>
		<tr>
