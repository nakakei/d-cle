<div class="eventcategories index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $eventcategory['Eventcategory']['id']), null, __('Are you sure you want to delete # %s?', $eventcategory['Eventcategory']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
