...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Eventcategory'), array('action' => 'delete', $eventcategory['Eventcategory']['id']), null, __('Are you sure you want to delete # %s?', $eventcategory['Eventcategory']['id'])); ?> </li>
