<div class="jobtreatments view">
<h2><?php echo __('Jobtreatment'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($jobtreatment['Jobtreatment']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($jobtreatment['Jobtreatment']['name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Jobtreatment'), array('action' => 'edit', $jobtreatment['Jobtreatment']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Jobtreatment'), array('action' => 'delete', $jobtreatment['Jobtreatment']['id']), array(), __('Are you sure you want to delete # %s?', $jobtreatment['Jobtreatment']['id'])); ?> </li>
...
<div class="related">
	...
	<?php foreach ($jobtreatment['Job'] as $job): ?>
		<tr>
