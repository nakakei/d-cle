...
<?php echo $this->Form->create('Snaptag'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Snaptag'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Snaptag.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Snaptag.id'))); ?></li>
