<div class="shopgenres view">
<h2><?php echo __('Shopgenre'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($shopgenre['Shopgenre']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($shopgenre['Shopgenre']['name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Shopgenre'), array('action' => 'edit', $shopgenre['Shopgenre']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Shopgenre'), array('action' => 'delete', $shopgenre['Shopgenre']['id']), array(), __('Are you sure you want to delete # %s?', $shopgenre['Shopgenre']['id'])); ?> </li>
...
<div class="related">
	...
	<?php foreach ($shopgenre['Shop'] as $shop): ?>
		<tr>
