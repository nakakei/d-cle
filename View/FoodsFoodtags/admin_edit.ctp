...
<?php echo $this->Form->create('FoodsFoodtag'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Foods Foodtag'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('FoodsFoodtag.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('FoodsFoodtag.id'))); ?></li>
